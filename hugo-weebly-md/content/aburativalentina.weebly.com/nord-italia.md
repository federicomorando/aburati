---
title: "Nord Italia"
body_class: "no-header-page wsite-theme-light  wsite-page-nord-italia"
source_file: "nord-italia.html"
---
...
<div><div id="928416397761415467" align="left" style="width: 100%; overflow-y: hidden;" class="wcustomhtml"><a name="farinata"></a><b><h1>VINO E FARINATA,  Savona</h1></b><br>

Vino e Farinata, Via Pia, 15, Savona<br>
Un bugigattolo proprio in centro a Savona, l'ideale per uno pranzo veloce a base di vino e farinata (ma va????), ma anche per un pasto luculliano a base di pesce.... Uno stretto corridoio accanto al forno a legna conduce nel locale composto da una serie di piccole stanze che si differenziano per la comodità dei tavoli, la dimensione degli stessi, il tipo ed il costo del coperto. Se non avete prenotato vi può capitare di trovarvi nello stesso tavolo con altri avventori che hanno scelto di condividere il tavolo (ma non il conto) per ridurre l'attesa, altrimenti mettetevi in coda, in un paio d'ore forse riuscirete a sedervi. I tavoli sono molto spartani, le sedie tutte diverse, le tovaglie di carta, le porcellane ed i bicchieri da trattoria. Il menù varia col pescato del giorno: sbrigatevi ad ordinare e cercate di farvi tenere in caldo le porzioni: infatti appena le teglie vengono sfornate e le zuppe sono pronte si preparano i vassoi che vengono distribuite a tempo per tutto il locale. La coda per sedersi è spesso molto lunga e potete prenotare, ma solo di persona o tramite telegramma. Quando noi andiamo spesso prenotiamo per la volta successiva, tanto la lista di attesa per il sabato sera è spesso piuttosto lunga.<br>
Ma qui quello che conta è il mangiare, non di certo il posto.<br>
...
<div><div id="707194023364309411" align="left" style="width: 100%; overflow-y: hidden;" class="wcustomhtml"><a name="arnaldo"></a><b><h1>Arnaldo,  Rubiera</h1></b><br>
Arnaldo, Clinica Gastronomica, Piazza XXIV Maggio, 3 - 42048 Rubiera (RE) Italy (<a href="http://www.clinicagastronomica.net/" target="_blank">www.clinicagastronomica.net</a>)<br>
Ci trovavamo per caso in Emilia a trovare degli amici e dopo alcuni giri infruttuosi a livello "alimentare" (nonostante la zona) decidiamo di controllare le recensioni e le stelle Michelin online, "scoprendo" questo ristorante con 1 stella Michelin. Per caso, nonostante la prenotazione all'ultimo minuto riusciamo a trovare posto nonostante il sabato sera. Combinazione vuole che ci troviamo in zona quasi un'ora prima del previsto e quindi chiamiamo chiedendo se per caso potevamo anticipare di mezz'ora la cena. Risposta sgarbatissima al telefono, ma in fondo un ristornate strapieno... certo ci sembra strano visto che la prenotazione era per le 20:30 che per quell'ora pensassero di aver già finito un giro di servizio... La cosa non promette bene....<br>
Arrivati in zona con ancora le migliori intenzioni addosso veniamo letteralmente assaliti da un avventore che ci dice "è tutto pieno, non provate ad entrare" e sapendo che eravamo riusciti a prenotare finisce con "beati voi". Il nostro umore migliora....<br>
Entriamo.... un misto di terrore ci assale: ristorante rumoroso e strapieno con i tavoli vicinissimi. Ci fanno accomodare (senza molto garbo) in una stanza un po' più appartata con la muffa alle pareti, macchie di umidità ovunque ed il muro in piena "fioritura". Accanto a noi un tavolo con due bambini urlanti.<br>
